...
;(function(_doc){
	...
	function creatWeather( optionDefaults, _parameter){		
		...
		//无阻赛 加载 样式
		include([ _path +'../css/main.css', _path +'../images/'+ option.style + ( option.styleSize ? '/'+ option.styleSize : ''  ) +'/weather.css']);
		;jQuery(function($){
			...
			//无阻赛 加载 天气渲染 js
			include([ _path +'jquery.weather.js', _path +'jquery.weather.config-'+ charset +'.js' ],function(){				
