...
namespace PM.Data {
    ...
    public class Assetmeter {
        ...
        public static AssetmeterInfo LoadAssetmeterInfo(IDataReader reader) {
            ...
            assetmeterInfo.Active = reader.IsDBNull(reader.GetOrdinal("Active")) == null ? true : Convert.ToBoolean(reader["Active"]);
            ...
            assetmeterInfo.Average =  reader.IsDBNull(reader.GetOrdinal("Active"))==null ? 0 : Convert.ToDecimal(reader["Average"]);
            ...
            assetmeterInfo.Hasld = reader.IsDBNull(reader.GetOrdinal("Hasld")) == null ? true : Convert.ToBoolean(reader["Hasld"]);
            ...
            assetmeterInfo.Lifetodate = reader.IsDBNull(reader.GetOrdinal("Lifetodate"))==null ? 0 : Convert.ToDecimal(reader["Lifetodate"]);
            ...
            assetmeterInfo.Rollover =  reader.IsDBNull(reader.GetOrdinal("Rollover"))==null ? 0 : Convert.ToDecimal(reader["Rollover"]);
            assetmeterInfo.Sequence = TypeConverter.ObjectToInt(reader["Assetmeterid"]);
            assetmeterInfo.Sinceinstall =  reader.IsDBNull(reader.GetOrdinal("Sinceinstall"))==null ? 0 : Convert.ToDecimal(reader["Sinceinstall"]);
            assetmeterInfo.Sincelastinspect =  reader.IsDBNull(reader.GetOrdinal("Sincelastinspect"))==null ? 0 : Convert.ToDecimal(reader["Sincelastinspect"]);
            assetmeterInfo.Sincelastoverhaul =  reader.IsDBNull(reader.GetOrdinal("Sincelastoverhaul"))==null ? 0 : Convert.ToDecimal(reader["Sincelastoverhaul"]);
            assetmeterInfo.Sincelastrepair =  reader.IsDBNull(reader.GetOrdinal("Sincelastrepair"))==null ? 0 : Convert.ToDecimal(reader["Sincelastrepair"]);
            assetmeterInfo.Siteid = reader["Siteid"].ToString();
            assetmeterInfo.Slidingwindowsize = TypeConverter.ObjectToInt(reader["Assetmeterid"]);
