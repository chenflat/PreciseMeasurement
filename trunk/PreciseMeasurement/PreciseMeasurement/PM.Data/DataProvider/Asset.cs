...
namespace PM.Data {
    ...
    public class Asset {
        ...
        public static AssetInfo LoadAssetInfo(IDataReader reader) {
            ...
            assetInfo.Disabled = Convert.ToBoolean(reader["Classstructureid"]);
            ...
            assetInfo.Haschildren = Convert.ToBoolean(reader["Haschildren"]);
            assetInfo.Hasmoredesc = Convert.ToBoolean(reader["Hasmoredesc"]);
            assetInfo.Installdate = TypeConverter.ObjectToDateTime(reader["Installdate"].ToString());
            assetInfo.Isrunning = Convert.ToBoolean(reader["Isrunning"]);
            assetInfo.Langcode = reader["Langcode"].ToString();
            assetInfo.Location = reader["Location"].ToString();
            assetInfo.Mainthierchy = Convert.ToBoolean(reader["Mainthierchy"]);
            assetInfo.Manufacturer = reader["Manufacturer"].ToString();
            assetInfo.Moved = Convert.ToBoolean(reader["Moved"]);
            ...
            assetInfo.Ec5 = Convert.ToDecimal(reader["Ec5"]);
            assetInfo.Ec6 = TypeConverter.ObjectToDateTime(reader["Ec6"].ToString());
            assetInfo.Ec7 = Convert.ToDecimal(reader["Ec7"]);
