...
namespace PM.Config
{
    ...
    public class BaseConfigInfo : IConfigInfo
    {
        ...
        private string m_dbconnectstring = "Data Source=;User ID=pm;Password=;Initial Catalog=;Pooling=true";		// 数据库连接串-格式(中文为用户修改的内容)：Data Source=数据库服务器地址;User ID=您的数据库用户名;Password=您的数据库用户密码;Initial Catalog=数据库名称;Pooling=true
        private string m_tableprefix = "";		// 数据库中表的前缀
        private string m_systempath = "/";			// 论坛在站点内的路径
