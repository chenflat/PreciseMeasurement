...
namespace PM.Common
{
    public class Utils
    {
        ...
        public class VersionInfo
        {
            ...
            {
                get { return "MeasureSystem"; }
            }
            public string LegalCopyright
            {
                get { return "2013, ManagementSystem Inc."; }
            }
        }
        ...
        {
            if (Utils.HasLength(stringarray))
                return false;
        ...
        public static string GetFileExtName(string fileName)
        {
            if (Utils.HasLength(fileName) || fileName.IndexOf('.') <= 0)
                return "";
