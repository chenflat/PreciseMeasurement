...
namespace PM.Common
{
    public class PMParam
    {
        ...
        protected PMParam(string name, object value)
        {
            this.name = name;
            this.value = value;
        }
        ...
        /// <param name="name">参数名称</param>
        /// <param name="value">参数值</param>
        /// <returns>返回PM参数</returns>
        public static PMParam Create(string name, object value)
        {
            return new PMParam(name, value);
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            return this.name.CompareTo((obj as PMParam).name);
        }

        /// <summary>
        /// 将PM参数数组转换为名值串
        /// </summary>
        /// <param name="a">PM参数数组</param>
